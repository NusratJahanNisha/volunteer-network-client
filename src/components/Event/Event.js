            ...
            <div className="row">
                ...
                <div className="col-md-9"> <h5 style={{ textAlign: "center", margin: "40px" }}>
                    ...
                    <form className="ship-form" onSubmit={handleSubmit(onSubmit)}>
                        <input name="event" style={{ marginLeft: '270px', marginTop: "10px", width: '300px', height: '40px' }} ref={register({ required: true })} placeholder="Event Title" />
                        {errors.event && <span className="error" style={{ color: "red", margin: "5px" }} >event is required </span>}

                        <input name="date" style={{ marginLeft: '270px', marginTop: "10px", width: '300px', height: '40px' }} ref={register({ required: true })} placeholder="Event Date" />
                        {errors.date && <span className="error" style={{ color: "red", margin: "5px" }} >date is required </span>}

                        <input name="description" style={{ marginLeft: '270px', marginTop: "10px", width: '300px', height: '40px' }} ref={register({ required: true })} placeholder="Your Description" />
                        {errors.description && <span className="error" style={{ color: "red", margin: "5px" }}>Description is required</span>}<br/>
